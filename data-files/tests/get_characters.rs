...
async fn it_should_read_base_stats() {
    ...
    let schrimp = &app
        .get_all_characters(vec!["Schrimp".to_string()])
        .await
        .unwrap()[0];
    ...
    assert_eq!(schrimp.con, (1, None));
    assert_eq!(schrimp.agi, (4, None));
    assert_eq!(schrimp.rea, (2, None));
    assert_eq!(schrimp.str, (1, None));
    assert_eq!(schrimp.wil, (4, None));
    assert_eq!(schrimp.log, (6, None));
    assert_eq!(schrimp.int, (4, None));
    assert_eq!(schrimp.cha, (2, None));
    ...
    assert_eq!(schrimp.resist_physical, 1);
    ...
    assert_eq!(schrimp.physical_hit, 9);
